...
with(subset(pf, year_joined.bucket == (2012, 2014], mean))

```

On average, which group initiated the greastest proportion of its Facebook friendship? People who joined after 2012.

For the group with the largest proportion of friendships initiated, what is the group's average (mean) proportion of friendships initiated? The mean is `r with(subset(pf, year_joined.bucket == (2012, 2014), mean))`





Why do you think this group's proportion of friendships initiated is higher than others?
